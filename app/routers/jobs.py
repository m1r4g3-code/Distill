...
@router.get(
    ...
    description="Retrieve the current polling status, progress metrics, and timestamp tracking for a dispatched background job ID."
)
...
@router.get(
    ...
    description="Fetch the final resolved output (URLs, datasets, schemas) generated by a successfully completed background job."
)
