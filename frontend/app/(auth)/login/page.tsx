                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                required
                                className={`w-full pl-10 pr-4 py-3 rounded-xl border ${error ? "border-error" : "border-border"
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                placeholder="••••••••"
                                required
                                className={`w-full pl-10 pr-12 py-3 rounded-xl border ${error ? "border-error" : "border-border"
                                    } bg-surface text-text-primary placeholder:text-text-muted text-sm outline-none focus:border-accent transition-colors`}
                            />
                            <button
                                type="button"
